...
namespace iShop.Web.AdmidApp.Controllers
{
    public class LoginController : Controller
    {
        ...
        public async Task<IActionResult> Index(LoginRequest request)
        {
            ...
            var usePrincipal = this.ValidateToken(token.ResultObj);
            ...
            await HttpContext.SignInAsync(CookieAuthenticationDefaults.AuthenticationScheme, usePrincipal, authPropertier);
